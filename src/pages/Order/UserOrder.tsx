    ...
    <div>
      ...
      <div>
        <div className='mobile:min-w-[350px] mobile:max-w-[450px] flex mb-[50px]  w-[1200px] h-[50px]  shadow-[0_30px_100px_-15px_rgba(0,0,0,0.2)]'>
          <div className='pt-4 mobile:w-[23%] w-[20%] text-center font-bold'>SẢN PHẨM</div>
          <div className='pt-4 mobile:w-[23%] mobile:hidden w-[20%] text-center font-bold'>GIÁ</div>
          <div className='pt-4 mobile:w-[23%] w-[20%] text-center font-bold'>SỐ LƯỢNG</div>
          <div className='pt-4 mobile:w-[23%] w-[20%] text-center font-bold'>TỔNG</div>
          <div className='pt-4 mobile:w-[23%] w-[20%] text-center font-bold'>XÓA</div>
        </div>
        <div className='flex items-center justify-between w-[1200px] mb-[50px] mobile:min-w-[350px] mobile:max-w-[450px]'>
          <div className='w-[20%] mobile:w-[27%]  justify-center flex items-center'>
            <div className=''>
              <img className='w-[80px] h-[auto]' src={Dienthoai1} alt='' />
            </div>
            <div className='mobile:hidden'>Reno8T 5G</div>
          </div>
          <div className='flex w-[20%] mobile:hidden mobile:w-[27%] mobile:text-xs justify-center'>
            10,000,000
            <p>Đ</p>
          </div>
          <div className='flex w-[20%] mobile:w-[27%] mobile:text-xs justify-center'>
            <button
          ...
          <div className='flex w-[20%] mobile:w-[27%] justify-center'>
            {10000000 * quantity}
            <p>Đ</p>
          </div>
          <div className='flex w-[20%] mobile:w-[27%] mobile:mr-9 justify-center'>
